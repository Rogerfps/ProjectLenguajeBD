    ...
    http
        .authorizeHttpRequests(auth -> auth
            ...
            .requestMatchers(
                ...
                "/css/**", "/js/**", "/webjars/**","/categoria/listado", "/categoria/nuevo", "/categoria/modificar/**", "/categoria/eliminar/**", "/categoria/guardar",
                "/plato/nuevo", "/plato/modificar/**", "/plato/eliminar/**", "/plato/guardar", "/pruebas/**","/facturar/carrito","/plato/listado", "/categoria/listado"
            )
            .permitAll()
